...
//    UITapGestureRecognizer *tapimg=[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(tapleft)];
//    [self.videoControl.leftview addGestureRecognizer:tapimg];
   // [self cusbrightnessUi];
     [self configObserver];
